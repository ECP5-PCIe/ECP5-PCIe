...
if __name__ == "__main__":
	...
	traces = [pcie.serdes_d.lane.tx_symbol, pcie.serdes_d.lane.rx_symbol, pcie.refclkcounter, pcie.phy_d.ltssm.debug_state, pcie.phy_u.ltssm.debug_state, pcie.phy_d.descrambled_lane.tx_symbol,
			 pcie.send_skp]
