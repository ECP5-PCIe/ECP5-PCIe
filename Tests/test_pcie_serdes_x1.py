...
class SERDESTestbench(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        debug = UARTDebugger(uart, 2, CAPTURE_DEPTH, Cat(lane.rx_symbol[0:9], lane.rx_aligned, Signal(6)), "rx", triggered) # lane.rx_present & lane.rx_locked)
        m.submodules += debug
