...
class LatticeECP5PCIeSERDESx4(Elaboratable): # Based on Yumewatari
    ...
    def elaborate(self, platform: Platform) -> Module:
        ...
        m.submodules.serdes = serdes = LatticeECP5PCIeSERDES(2, DCU=self.DCU, CH=self.CH)
        ...
        platform.add_clock_constraint(self.rx_clk, 63e6) # For NextPNR, set the maximum clock frequency such that errors are given
        platform.add_clock_constraint(self.tx_clk, 63e6)
