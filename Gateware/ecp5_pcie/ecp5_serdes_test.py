...
class LatticeECP5PCIeSERDES(Elaboratable): # Based on Yumewatari
    ...
    def __init__(self, gearing):
        ...
        self.tx_bus_s_2 = Signal(len(self.tx_bus))
...
#
        ...
        osc = Signal()
        m.d.tx += osc.eq(~osc)
        m.d.comb += tx_bus_s_2.eq(Cat(
                    Mux(osc, Ctrl.COM, Ctrl.SKP), Signal(), Signal(), Signal(),
                    Ctrl.SKP, Signal(), Signal(), Signal()))
        return m