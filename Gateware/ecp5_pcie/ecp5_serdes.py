...
class LatticeECP5PCIeSERDES(Elaboratable): # Based on Yumewatari
    ...
    """
    def __init__(self, gearing, speed5GT = False, DCU=0, CH=0):
    ...
    def elaborate(self, platform: Platform) -> Module:
        ...
        platform.add_clock_constraint(self.rx_clk, (500e6 if self.speed5GT else 250e6) / self.gearing) # For NextPNR, set the maximum clock frequency such that errors are given
        platform.add_clock_constraint(self.tx_clk, (500e6 if self.speed5GT else 250e6) / self.gearing)
